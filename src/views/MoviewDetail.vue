    ...
    <div class="movie__info">
      ...
      <div class="movie__info-detail">
        ...
        <h2 class="movie__info-sub">
          ...
          <a href="" class="movie__info-sub-link">(2024)</a>
        </h2>
        <div class="movie__info-episode-list">
          <span class="movie__info-episode-duration">
            56 phút/tập
          </span>
          <span class="movie__info-episode-completed">
            Hoàn Tất (7/7)
          </span>
        </div>
        ...
        <div class="movie__info-button-wrapper">
          ...
          <div class="movie__info-category-list">
            <a href="" class="border border-white rounded-pill btn-category">Hành động</a>
            <a href="" class="border border-white rounded-pill btn-category">Hành động</a>
            <a href="" class="border border-white rounded-pill btn-category">Hành động</a>
          </div>
        </div>
        <div class="movie__info-horizontal">
          <div class="movie__info-horizontal-list">
            <div class="movie__info-horizontal-item">
              ...
              <span>
                <a href="" class="movie__info-horizontal-text">Đang cập nhật...</a>
              </span>
            </div>
            <div class="movie__info-horizontal-item">
        ...
        <div class="movie__info-trailer">
          <img src="https://img.youtube.com/vi/oqxAJKy0ii4/hqdefault.jpg" alt="">
